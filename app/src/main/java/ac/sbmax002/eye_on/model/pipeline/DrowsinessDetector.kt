...
class DrowsinessDetector(
    ...
    private val drowsyRatio: Float = 0.75f,
    private val sleepingRatio: Float = 0.35f,
    private var drowsyDurationMs: Long = 1_000L,
    private val sleepingDurationMs: Long = 2_000L,
